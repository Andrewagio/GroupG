                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary"style="background:inherit">
                        <div class="card-header">
                            <h4 style="color:white">Please enter your Staff ID</h4>
                        </div>
                        <div class="card-body" >
                            <form method="POST" action="confirm-sms.php" class="needs-validation" novalidate="">
                                <div class="form-group">
                                    <label for="email" style="color:white">Staff number</label>
                                    <input  type="text" class="form-control" name="CAGD_CODE" tabindex="1" required autofocus>
	...
	<?php 
		...
		?>
		 <input type="hidden" name="password"class="form-control" value="<?php echo $random;?>" required>
                                ...
                                <div class="form-group">
                                    <button  name="set-pass" type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                                    SET PASSWORD
                                    </button>
